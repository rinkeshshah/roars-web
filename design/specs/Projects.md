# Projects — element spec

Source prototype: `design/Roars v2 - Projects.dc.html`  ·  desktop canvas 1440px wide, all desktop elements absolutely positioned inside their section (coordinates are relative to the section unless noted).
...
- div — l:39px t:96px w:384px h:232px
  ...
  - span — l:0 t:74px w:384px h:150px  |  type 22px / 500 / 30px / -0.04em / rgba(255,255,255,.92)
      text: "250 products delivered since 2005, across logistics, fitness, health-tech, hospitality, legal and SaaS."
- div — l:488.849px t:440px w:778.151px h:253px
  - div — l:0 t:23px w:465.152px h:157.176px
    - img — l:1.026px t:139.875px w:73.401px h:8.868px  |  transform:rotate(6.66deg); filter:invert(1)  |  src="assets/union.svg"
    - span — l:6.151px t:52px w:459px h:86px  |  type 124px / 600 / 86px / -0.04em / rgb(251,251,251)  |  white-space:nowrap
        text: "Projects"
  ...
  - div — l:479.151px t:0 w:299px h:43px
    ...
    - img — l:51px t:0 w:42px h:42px  |  border-radius:60px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/Atul.webp"
    - div — l:103px t:1px w:42px h:42px  |  background:rgb(255,255,255); border-radius:60px
      - span — l:5px t:8px w:33px h:24px  |  type 16px / 600 / 24px / -0.04em / rgb(0,0,0)  |  white-space:nowrap
          text: "250"
    - span — l:172px t:2px w:127px h:40px  |  type 14px / 500 / 20px / -0.04em / rgb(255,255,255)  |  opacity:.75
        text: "Products delivered"

### Projects  (top 780px, height 3836px)
background: rgb(255,255,255)  ·  overflow: hidden

- div — l:737px t:126px w:248px h:104px  |  overflow:hidden
  - span — l:0 t:0 w:200px h:104px  |  type 14px / 500 / 26px / -0.06em / rgb(71,71,71)  |  opacity:.8
      text: "Recent ProjectsProduct DevelopmentUI/UX and Product DesignMobile and AI"
    - br
    - br
    - br
  - div — l:232px t:15px w:16px h:79px  |  display:flex; flex-direction:column; justify-content:space-between
    - span — w:16px h:1px  |  background:rgb(71,71,71); opacity:.8; display:block
    - span — w:16px h:1px  |  background:rgb(71,71,71); opacity:.8; display:block
    - span — w:16px h:1px  |  background:rgb(71,71,71); opacity:.8; display:block
    - span — w:16px h:1px  |  background:rgb(71,71,71); opacity:.8; display:block
- sc-for [{{ projects }}]
  - a — l:39px t:{{ p.y }} w:1363px h:626px  |  display:block; overflow:hidden  |  href="Roars  v2 - Project Detail.dc.html"
    - div — l:0 t:3px w:86px h:68px
      - span — l:0 t:0 w:67px h:19px  |  type 24px / 500 / 19px / -0.06em / rgb(0,0,0)  |  white-space:nowrap
          text: "{{ p.date }}"
      - div — l:1px t:38px w:85px h:1.25px  |  background:rgb(71,71,71); opacity:.8
      - span — l:0 t:49px  |  type 14px / 500 / 19px / -0.06em / rgb(71,71,71)  |  opacity:.8; white-space:nowrap
          text: "{{ p.year }}"
    - div — l:120px t:1px w:1129px h:625px  |  background:rgb(30,30,30); border-radius:12px; overflow:hidden
      - img — w:100% h:100%  |  display:block; object-fit:cover  |  src="{{ p.img }}"  |  alt="{{ p.name }}"
      - div — l:0 h:45%  |  right:0; bottom:0; background:linear-gradient(0deg,rgba(0,0,0,.6) 0%,rgba(0,0,0,0) 100%)
    - div — l:1277px t:0 w:86px h:89px  |  overflow:hidden
      - img — l:0 t:0 w:40px h:40px  |  border-radius:60px; object-fit:cover  |  src="{{ p.a1 }}"
      - img — l:0 t:49px w:40px h:40px  |  border-radius:60px; object-fit:cover  |  src="{{ p.a2 }}"
    - span — l:696px t:506px w:420px h:42px  |  type 36px / 600 / 42px / -0.05em / rgb(255,255,255)  |  white-space:nowrap
        text: "{{ p.name }}"

### Footer  (top 4616px, height 1105px)
...
### M1 section (dark)
padding: 100px 20px 48px · background: #000 · layout: flex column gap 36px
- img — l:0 t:-6% w:100% h:112%  |  object-fit:cover  |  src="assets/space.jpg"
- div — l:0 t:0  |  right:0; bottom:0; background:linear-gradient(180deg,rgba(0,0,0,.55) 0%,rgba(0,0,0,.2) 42%,rgba(0,0,0,.7) 100%)
- div — display:flex; flex-direction:column; gap:36px
  ...
  - div — display:flex; flex-direction:column; gap:10px
    ...
    - span — type 66px / 600 / 66px / -0.04em / rgb(251,251,251)
        text: "Projects"
  - div — display:flex; align-items:center; gap:14px
    - div — display:flex; align-items:center
      - img — w:40px h:40px  |  border-radius:60px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/Abhishek.webp"
      - img — w:40px h:40px  |  border-radius:60px; margin-left:-9px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/Atul.webp"
      - div — w:40px h:40px  |  type 15px / 600 / -0.04em / #000  |  background:#fff; border-radius:60px; display:flex; align-items:center; justify-content:center; margin-left:-9px
          text: "250"
    - span — type 14px / 500 / 20px / -0.04em / rgb(255,255,255)  |  opacity:.75
        text: "Products delivered"

### M2 section
padding: 44px 20px 56px · background: #fff · layout: flex column gap 30px
- div — display:flex; flex-direction:column; gap:10px
  - div — h:1.5px  |  background:rgba(153,152,149,.7)
  - span — type 14px / 500 / 24px / -0.06em / rgb(71,71,71)  |  opacity:.8
      text: "Recent ProjectsProduct DevelopmentUI/UX and Product DesignMobile and AI"
    - br
    - br
    - br
- sc-for [{{ projects }}]
  - a — border-top:1px solid rgba(153,152,149,.55); display:flex; flex-direction:column; gap:12px  |  href="Roars  v2 - Project Detail.dc.html"
    - div — display:flex; align-items:center; justify-content:space-between
      - span — type 19px / 500 / -0.06em / rgb(20,20,20)
          text: "{{ p.date }}"
        - span — type rgb(153,152,149)
            text: "{{ p.year }}"
      - div — display:flex
        - img — w:32px h:32px  |  border-radius:60px; object-fit:cover  |  src="{{ p.a1 }}"
        - img — w:32px h:32px  |  border-radius:60px; box-shadow:0 0 0 2px #fff; margin-left:-8px; object-fit:cover  |  src="{{ p.a2 }}"
    - div — background:rgb(232,232,232); border-radius:12px; overflow:hidden; aspect-ratio:4/3
      - img — w:100% h:100%  |  display:block; object-fit:cover  |  src="{{ p.img }}"  |  alt="{{ p.name }}"
    - div — display:flex; align-items:center; justify-content:space-between; gap:12px
      - span — type 28px / 600 / 34px / -0.05em / rgb(20,20,20)
          text: "{{ p.name }}"
      - span — type 20px / rgba(20,20,20,.4)
          text: "→"
...
- span — type 19px / 500 / 28px / -0.04em / rgb(0,0,0)
    text: "Every project starts the same way — with the problem, not the screens. Tell us what’s broken."
...
class Component extends DCLogic {
  ...
  renderVals() {
    const A = 'https://www.roarsinc.com/wp-content/uploads/2022/07/';
    const list = [
      { date: '18 Feb', year: '2026', name: 'Snowman Logistics.', img: 'https://www.roarsinc.com/wp-content/uploads/2026/02/Snowman-Logistics-app-solution.jpg', a1: A + 'Abhishek.webp', a2: A + 'Nitin.webp' },
      { date: '02 Jul', year: '2025', name: 'GymBait.AI', img: 'https://www.roarsinc.com/wp-content/uploads/2025/07/ai-fitness-home.jpg', a1: A + 'Chetna.webp', a2: A + 'Atul.webp' },
      { date: '15 Oct', year: '2025', name: 'Parqly.', img: 'https://www.roarsinc.com/wp-content/uploads/2025/07/parqly-parking-mobile-app.jpg', a1: A + 'Atul.webp', a2: A + 'suzanne.webp' },
      { date: '09 May', year: '2025', name: 'Concierge Loyalty.', img: 'https://www.roarsinc.com/wp-content/uploads/2025/07/concierge-ai-home.jpg', a1: A + 'suzanne.webp', a2: A + 'Ankush.webp' },
      { date: '21 Mar', year: '2024', name: 'GISAID.', img: 'https://www.roarsinc.com/wp-content/uploads/2025/07/health-tech-covid.jpg', a1: A + 'Nitin.webp', a2: A + 'Khusboo.webp' }
    ];
    return { projects: list.map((p, i) => Object.assign({}, p, { y: (300 + i * 707) + 'px' })) };
  }
}
```