# Guide Detail — element spec

Source prototype: `design/Roars v2 - Guide Detail.dc.html`  ·  desktop canvas 1440px wide, all desktop elements absolutely positioned inside their section (coordinates are relative to the section unless noted).
...
<style>
  ...
  * { box-sizing:border-box; }
  ...
  input::placeholder { color:rgba(20,20,20,.35); }
...
- div — background:linear-gradient(180deg,rgba(0,0,0,.62) 0%,rgba(0,0,0,.22) 44%,rgba(0,0,0,.58) 100%)
- div — l:39px t:172px w:420px h:456px
  - a — l:0 t:0  |  type 12px / 500 / 19px / 0.18em / rgba(255,255,255,.55)  |  white-space:nowrap  |  href="Roars v2 - Guides.dc.html"
      text: "← BACK / GUIDES"
  - div — l:0 t:38px w:16px h:1.5px  |  background:#FFD400
  - span — l:0 t:64px w:410px h:258px  |  type 20px / 500 / 29px / -0.04em / rgba(255,255,255,.9)
      text: "The Business Model Canvas is a one page overview that lays out both what you do (or want to do), and how you go about doing it ; enabling structured conversations around management and strategy by laying out the crucial activities and challenges involved with your initiative and how they relate to each other."
  - a — l:0 t:346px w:195px h:42px  |  border-radius:60px; box-shadow:inset 0 0 0 2px rgba(255,255,255,.25); display:block  |  HOVER { box-shadow:inset 0 0 0 2px #FFD400 }  |  href="#form-section"
  ...
  - div — l:0 t:414px w:420px h:34px  |  display:flex; gap:8px
    ...
    - span — type 11px / 500 / 0.12em / rgba(255,255,255,.88)  |  border-radius:60px; box-shadow:inset 0 0 0 1px rgba(255,255,255,.24); padding:7px 13px
        text: "BUSINESS MODEL"
- div — l:500px t:360px w:620px h:290px
  ...
  - span — l:2px t:40px w:520px h:60px  |  type 56px / 600 / 60px / -0.05em / rgba(255,255,255,.6)  |  white-space:nowrap
      text: "Business Model"
  - img — l:6px t:102px w:88px h:10px  |  transform:rotate(5.4deg); filter:invert(1)  |  src="assets/union.svg"
  - span — l:0 t:106px w:700px h:130px  |  type 124px / 600 / 124px / -0.055em / rgb(251,251,251)  |  white-space:nowrap
      text: "Canvas"
- div — l:1092px t:168px w:320px h:340px
  - div — l:22px t:22px w:288px h:266px  |  background:rgba(251,251,249,.3); box-shadow:inset 0 0 0 1px rgba(255,255,255,.18); transform:rotate(3deg)
  - div — l:11px t:11px w:288px h:266px  |  background:rgba(251,251,249,.58); box-shadow:inset 0 0 0 1px rgba(255,255,255,.22); transform:rotate(1.5deg)
  - div — l:0 t:0 w:288px h:266px  |  background:#FBFBF9; box-shadow:0 30px 70px rgba(0,0,0,.5); transform:rotate(-1.2deg); overflow:hidden
    - div — l:0 t:0 w:288px h:4px  |  background:#FFD400
    - img — l:16px t:30px w:256px h:186px  |  object-fit:contain  |  src="https://www.roarsinc.com/wp-content/uploads/2022/08/business-model-canvas.png"  |  alt="Business Model Canvas"
    - span — l:18px t:232px  |  type 10px / 600 / 0.2em / rgba(20,20,20,.5)
        text: "PREVIEW"
    - span — l:214px t:232px  |  type 10px / 500 / 0.16em / rgba(20,20,20,.4)
        text: "PDF · 01"

### Reading  (top 700px, height 1140px)
...
- span — l:40px t:104px  |  type 12px / 500 / 19px / 0.18em / rgb(145,145,145)  |  white-space:nowrap
    text: "01 / PURPOSE"
- span — l:33px t:146px w:460px h:140px  |  type 52px / 600 / 58px / -0.05em / rgb(36,36,36)
    text: "What is this for?"
- div — l:580px t:150px w:822px h:400px
  - span — l:0 t:0 w:790px h:120px  |  type 20px / 500 / 31px / -0.04em / rgba(20,20,20,.88)
      text: "Existing programmes can develop new initiatives and identify opportunities while becoming more efficient by illustrating potential trade-offs and aligning activities. New programmes can use it to plan and work out how to make their offering real."
  - div — l:0 t:170px w:790px h:0.5px  |  background:rgba(153,152,149,.5)
  - span — l:0 t:198px w:790px h:160px  |  type 17px / 500 / 28px / -0.04em / rgba(20,20,20,.72)
      text: "The individual elements prompt thoughts within the separate activities or resources, while the capability to have the complete overview encourages fresh perspectives and ideas about how those pieces fit together. This structure also helps to keep group discussions more focused and bring everyone onto the same page."
- div — l:40px t:600px w:1362px h:1.5px  |  background:rgba(153,152,149,.7)
- span — l:40px t:624px  |  type 12px / 500 / 19px / 0.18em / rgb(145,145,145)  |  white-space:nowrap
    text: "02 / METHOD"
- span — l:33px t:666px w:460px h:140px  |  type 52px / 600 / 58px / -0.05em / rgb(36,36,36)
    text: "Step-by-step guide."
- div — l:580px t:670px w:822px h:420px
  - span — l:0 t:0 w:790px h:130px  |  type 20px / 500 / 31px / -0.04em / rgba(20,20,20,.88)
      text: "To make a Business Model Canvas, the easiest way to start is by filling out what you do. This helps keep the focus on your main goal as you fill out the other building blocks of the canvas. From there you can build on that goal and see how it can be achieved by adding details about the other activities and resources you have."
  - div — l:0 t:176px w:790px h:0.5px  |  background:rgba(153,152,149,.5)
  - span — l:0 t:204px w:790px h:160px  |  type 17px / 500 / 28px / -0.04em / rgba(20,20,20,.72)
      text: "Start from a blank canvas and add notes with keywords to each building block of the canvas. If you use ‘sticky notes’ for this, you can move ideas around as you fill out each building block in the canvas. You may want to colour-code elements related to a specific client segment."

### Get the file  (top 1840px, height 700px)
background: rgb(245,245,245)  ·  overflow: hidden

- span — l:33px t:150px w:700px h:100px  |  type 84px / 600 / 86px / -0.05em / rgb(36,36,36)  |  white-space:nowrap
    text: "Get the file!"
- span — l:38px t:260px w:520px h:60px  |  type 20px / 500 / 30px / -0.04em / rgba(20,20,20,.72)
    text: "Fill in this form to get a file download of the guide."
- div — l:44px t:356px w:360px h:240px
  - div — l:20px t:18px w:300px h:196px  |  background:rgb(237,237,235); box-shadow:inset 0 0 0 1px rgba(20,20,20,.08); transform:rotate(2.6deg)
  - div — l:10px t:9px w:300px h:196px  |  background:rgb(245,245,243); box-shadow:inset 0 0 0 1px rgba(20,20,20,.1); transform:rotate(1.2deg)
  - div — l:0 t:0 w:300px h:196px  |  background:#FBFBF9; box-shadow:inset 0 0 0 1px rgba(20,20,20,.14), 0 14px 34px rgba(0,0,0,.1); transform:rotate(-1deg); overflow:hidden
    - div — l:0 t:0 w:300px h:4px  |  background:#FFD400
    - span — l:20px t:26px  |  type 11px / 600 / 0.14em / rgba(20,20,20,.75)
        text: "BUSINESS-MODEL-CANVAS.PDF"
      - br
    - div — l:20px t:86px w:260px h:0.5px  |  background:rgba(20,20,20,.16)
    - span — l:20px t:104px  |  type 10px / 500 / 0.16em / rgba(20,20,20,.45)
        text: "ONE PAGE · FREE"
    - span — l:20px t:132px  |  type 10px / 500 / 0.16em / rgba(20,20,20,.45)
        text: "FILL THE FORM →"
    - div — l:222px t:114px w:52px h:52px  |  background:#FFD400; border-radius:60px; display:flex; align-items:center; justify-content:center
      - span — type 24px / 500 / 1 / rgb(20,20,20)
          text: "↓"
- div — l:580px t:174px w:822px h:380px
  - div — l:0 t:0 w:822px h:1.5px  |  background:rgba(153,152,149,.7)
  - span — l:0 t:32px  |  type 11px / 500 / 0.16em / rgba(20,20,20,.5)
      text: "FIRST NAME"
  - input — l:0 t:58px w:390px h:44px  |  type 18px / 500 / -0.04em / rgb(20,20,20)  |  background:transparent; border:none; border-bottom:1px solid rgba(20,20,20,.25); padding:0 0 8px 0
  - span — l:432px t:32px  |  type 11px / 500 / 0.16em / rgba(20,20,20,.5)
      text: "PROFESSIONAL EMAIL*"
  - input — l:432px t:58px w:390px h:44px  |  type 18px / 500 / -0.04em / rgb(20,20,20)  |  background:transparent; border:none; border-bottom:1px solid rgba(20,20,20,.25); padding:0 0 8px 0
  - div — l:0 t:150px w:204px h:47px  |  background:rgb(0,0,0); border-radius:60px  |  HOVER { transform:translateY(-2px) }
  ...
  - span — l:0 t:230px w:700px h:80px  |  type 13px / 500 / 21px / -0.03em / rgba(20,20,20,.55)
      text: "You may unsubscribe from these communications at any time. For more information on our privacy practices and how we are committed to protecting and respecting your privacy, please review our"
    - a — type 600 / rgb(20,20,20)  |  href="https://www.roarsinc.com/privacy-policy/"
        text: "privacy policy."

### More guides  (top 2540px, height 620px)
background: rgb(255,255,255)  ·  overflow: hidden

- div — l:40px t:146px w:16px h:1.5px  |  background:rgba(153,152,149,.7)
- span — l:40px t:166px  |  type 12px / 500 / 19px / 0.18em / rgb(145,145,145)  |  white-space:nowrap
    text: "NEXT IN THE SHELF"
- a — l:40px t:246px w:1362px h:62px  |  display:block  |  HOVER { background:rgba(255,212,0,.10) }  |  href="https://www.roarsinc.com/resources/building-partnerships/"
  - div — l:0 t:0 w:1362px h:0.5px  |  background:rgba(153,152,149,.5)
  - span — l:14px t:26px  |  type 11px / 500 / 0.14em / rgb(145,145,145)
      text: "BUSINESS MODEL"
  - span — l:260px t:16px  |  type 32px / 600 / 40px / -0.05em / rgb(36,36,36)  |  white-space:nowrap
      text: "Building Partnerships"
  - span — l:1290px t:20px  |  type 24px / 500 / 32px / rgba(20,20,20,.45)
      text: "→"
- a — l:40px t:308px w:1362px h:62px  |  display:block  |  HOVER { background:rgba(255,212,0,.10) }  |  href="https://www.roarsinc.com/resources/business-plan/"
  - div — l:0 t:0 w:1362px h:0.5px  |  background:rgba(153,152,149,.5)
  - span — l:14px t:26px  |  type 11px / 500 / 0.14em / rgb(145,145,145)
      text: "BUSINESS MODEL"
  - span — l:260px t:16px  |  type 32px / 600 / 40px / -0.05em / rgb(36,36,36)  |  white-space:nowrap
  ...
  - span — l:1290px t:20px  |  type 24px / 500 / 32px / rgba(20,20,20,.45)
      text: "→"
- a — l:40px t:370px w:1362px h:62px  |  display:block  |  HOVER { background:rgba(255,212,0,.10) }  |  href="https://www.roarsinc.com/resources/swot-analysis/"
  - div — l:0 t:0 w:1362px h:0.5px  |  background:rgba(153,152,149,.5)
  - span — l:14px t:26px  |  type 11px / 500 / 0.14em / rgb(145,145,145)
      text: "OUR FAVOURITE"
  - span — l:260px t:16px  |  type 32px / 600 / 40px / -0.05em / rgb(36,36,36)  |  white-space:nowrap
...
- a — l:40px t:474px  |  type 16px / 600 / 22px / -0.04em / rgb(20,20,20)  |  href="Roars v2 - Guides.dc.html"
    text: "All guides →"

### Footer  (top 3160px, height 1105px)
...
- div — l:43px t:734px w:1053px h:310px  |  overflow:hidden
  ...
  - div — l:0 t:238px w:1053px h:72px  |  overflow:hidden
    ...
    - div — l:459px t:0 w:247px h:72px  |  type 12px / 500 / 21px / -0.04em / rgba(255,255,255,.8)  |  display:flex; flex-direction:column
      - a — href="https://www.roarsinc.com/privacy-policy/"
          text: "Privacy Policy"
      - a — href="#"
...
### M1 section (dark)
padding: 96px 20px 48px · background: #000 · layout: flex column gap 28px
- img — l:0 t:-6% w:100% h:112%  |  object-fit:cover  |  src="assets/space.jpg"
- div — l:0 t:0  |  right:0; bottom:0; background:linear-gradient(180deg,rgba(0,0,0,.66) 0%,rgba(0,0,0,.26) 44%,rgba(0,0,0,.62) 100%)
- div — display:flex; flex-direction:column; gap:28px
  - div — display:flex; flex-direction:column; gap:14px
    - a — type 11px / 500 / 0.18em / rgba(255,255,255,.55)  |  href="Roars v2 - Guides.dc.html"
        text: "← BACK / GUIDES"
  ...
  - div — display:flex; flex-direction:column; gap:6px
    ...
    - span — type 34px / 600 / 38px / -0.05em / rgba(255,255,255,.6)
        text: "Business Model"
    - span — type 56px / 600 / 58px / -0.055em / rgb(251,251,251)
        text: "Canvas"
  - span — type 17px / 500 / 27px / -0.04em / rgba(255,255,255,.9)
      text: "The Business Model Canvas is a one page overview that lays out both what you do (or want to do), and how you go about doing it ; enabling structured conversations around management and strategy by laying out the crucial activities and challenges involved with your initiative and how they relate to each other."
  - div — w:100%  |  max-width:270px; background:#FBFBF9; box-shadow:0 24px 56px rgba(0,0,0,.5); transform:rotate(-1.2deg); padding:0 0 14px
    - div — h:4px  |  background:#FFD400
    - img — w:100% h:auto  |  display:block; padding:20px 16px 10px; object-fit:contain  |  src="https://www.roarsinc.com/wp-content/uploads/2022/08/business-model-canvas.png"  |  alt="Business Model Canvas"
    - div — type 10px / 600 / 0.18em / rgba(20,20,20,.5)  |  display:flex; justify-content:space-between; padding:0 16px
      - span
          text: "PREVIEW"
...
- span — type 40px / 600 / 44px / -0.05em / rgb(36,36,36)
    text: "What is this for?"
- span — type 18px / 500 / 29px / -0.04em / rgba(20,20,20,.88)
    text: "Existing programmes can develop new initiatives and identify opportunities while becoming more efficient by illustrating potential trade-offs and aligning activities. New programmes can use it to plan and work out how to make their offering real."
- span — type 16px / 500 / 26px / -0.04em / rgba(20,20,20,.72)  |  border-top:.5px solid rgba(153,152,149,.5)
    text: "The individual elements prompt thoughts within the separate activities or resources, while the capability to have the complete overview encourages fresh perspectives and ideas about how those pieces fit together. This structure also helps to keep group discussions more focused and bring everyone onto the same page."
- div — display:flex; flex-direction:column; gap:10px
  - div — h:1.5px  |  background:rgba(153,152,149,.7)
  - span — type 11px / 500 / 0.18em / rgb(145,145,145)
...
- span — type 52px / 600 / 54px / -0.05em / rgb(36,36,36)
    text: "Get the file!"
- span — type 18px / 500 / 28px / -0.04em / rgba(20,20,20,.72)
    text: "Fill in this form to get a file download of the guide."
- div — w:100%  |  max-width:290px; background:#FBFBF9; box-shadow:inset 0 0 0 1px rgba(20,20,20,.14), 0 14px 34px rgba(0,0,0,.1); transform:rotate(-1deg); padding:0 0 18px
  - div — h:4px  |  background:#FFD400
  - div — display:flex; align-items:flex-start; justify-content:space-between; gap:14px; padding:22px 18px 0
    - div — display:flex; flex-direction:column; gap:14px
      - span — type 11px / 600 / 17px / 0.14em / rgba(20,20,20,.75)
          text: "BUSINESS-MODEL-CANVAS.PDF"
        - br
      - div — h:.5px  |  background:rgba(20,20,20,.16)
      - span — type 10px / 500 / 0.16em / rgba(20,20,20,.45)
          text: "ONE PAGE · FREE"
      - span — type 10px / 500 / 0.16em / rgba(20,20,20,.45)
          text: "FILL THE FORM →"
    - div — w:48px h:48px  |  type 22px / 500 / rgb(20,20,20)  |  background:#FFD400; border-radius:60px; display:flex; align-items:center; justify-content:center; flex:none
        text: "↓"
- div — border-top:1.5px solid rgba(153,152,149,.7); display:flex; flex-direction:column; gap:22px
  - div — display:flex; flex-direction:column; gap:8px
    - span — type 11px / 500 / 0.16em / rgba(20,20,20,.5)
        text: "FIRST NAME"
    - input — w:100% h:44px  |  type 17px / 500 / -0.04em / rgb(20,20,20)  |  background:transparent; border:none; border-bottom:1px solid rgba(20,20,20,.25); padding:0 0 8px
  - div — display:flex; flex-direction:column; gap:8px
    - span — type 11px / 500 / 0.16em / rgba(20,20,20,.5)
        text: "PROFESSIONAL EMAIL*"
    - input — w:100% h:44px  |  type 17px / 500 / -0.04em / rgb(20,20,20)  |  background:transparent; border:none; border-bottom:1px solid rgba(20,20,20,.25); padding:0 0 8px
  - div — h:52px  |  background:rgb(0,0,0); border-radius:60px; display:flex; align-items:center; justify-content:space-between; padding:0 24px
    - span — type 14px / 500 / -0.03em / rgb(255,255,255)
        text: "Download"
    - span — display:flex; gap:3px
      - span — w:8px h:8px  |  background:rgba(153,152,149,.6); border-radius:50%
      - span — w:8px h:8px  |  background:#FFD400; border-radius:50%
  - span — type 13px / 500 / 21px / -0.03em / rgba(20,20,20,.55)
      text: "You may unsubscribe from these communications at any time. For more information on our privacy practices and how we are committed to protecting and respecting your privacy, please review our"
    - a — type 600 / rgb(20,20,20)  |  href="https://www.roarsinc.com/privacy-policy/"
        text: "privacy policy."

### M4 section
padding: 44px 20px 56px · background: #fff · layout: flex column gap 20px
- div — display:flex; flex-direction:column; gap:10px
  - div — w:16px h:1.5px  |  background:rgba(153,152,149,.7)
  - span — type 11px / 500 / 0.18em / rgb(145,145,145)
      text: "NEXT IN THE SHELF"
- div — display:flex; flex-direction:column
  - a — border-top:.5px solid rgba(153,152,149,.5); display:flex; flex-direction:column; gap:4px; padding:15px 0  |  href="https://www.roarsinc.com/resources/building-partnerships/"
    - span — type 11px / 500 / 0.14em / rgb(145,145,145)
        text: "BUSINESS MODEL"
    - div — display:flex; align-items:center; justify-content:space-between; gap:12px
      - span — type 26px / 600 / -0.05em / rgb(36,36,36)
          text: "Building Partnerships"
      - span — type 20px / rgba(20,20,20,.45)
          text: "→"
  - a — border-top:.5px solid rgba(153,152,149,.5); display:flex; flex-direction:column; gap:4px; padding:15px 0  |  href="https://www.roarsinc.com/resources/business-plan/"
    - span — type 11px / 500 / 0.14em / rgb(145,145,145)
        text: "BUSINESS MODEL"
    - div — display:flex; align-items:center; justify-content:space-between; gap:12px
      - span — type 26px / 600 / -0.05em / rgb(36,36,36)
      ...
      - span — type 20px / rgba(20,20,20,.45)
          text: "→"
  - a — border-top:.5px solid rgba(153,152,149,.5); border-bottom:.5px solid rgba(153,152,149,.5); display:flex; flex-direction:column; gap:4px; padding:15px 0  |  href="https://www.roarsinc.com/resources/swot-analysis/"
    - span — type 11px / 500 / 0.14em / rgb(145,145,145)
        text: "OUR FAVOURITE"
    - div — display:flex; align-items:center; justify-content:space-between; gap:12px
      - span — type 26px / 600 / -0.05em / rgb(36,36,36)
      ...
      - span — type 20px / rgba(20,20,20,.45)
          text: "→"
- a — type 16px / 600 / -0.04em / rgb(20,20,20)  |  href="Roars v2 - Guides.dc.html"
    text: "All guides →"
...
class Component extends DCLogic {
  componentDidMount() {
    ...
    this.rows = () => {
      ...
      fields.forEach(f => {
        f.addEventListener('focus', () => { f.style.borderBottom = '1px solid ' + accent; });
        f.addEventListener('blur', () => { f.style.borderBottom = '1px solid rgba(20,20,20,.25)'; });
      });
    };
