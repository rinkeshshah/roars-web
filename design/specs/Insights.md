# Insights — element spec

Source prototype: `design/Roars v2 - Insights.dc.html`  ·  desktop canvas 1440px wide, all desktop elements absolutely positioned inside their section (coordinates are relative to the section unless noted).
...
- div — l:39px t:96px w:384px h:232px
  ...
  - span — l:0 t:74px w:384px h:150px  |  type 22px / 500 / 30px / -0.04em / rgba(255,255,255,.92)
      text: "We have a lot to say about product work, how we approach the process, and the nuances of building for founders."
- div — l:488.849px t:440px w:778.151px h:253px
  - div — l:0 t:23px w:449.152px h:157.176px
    ...
    - span — l:6.151px t:52px w:443px h:86px  |  type 124px / 600 / 86px / -0.04em / rgb(251,251,251)  |  white-space:nowrap
        text: "Insights"
  ...
  - div — l:479.151px t:0 w:299px h:43px
    - img — l:0 t:0 w:42px h:42px  |  background:rgb(173,173,173); border-radius:60px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/Chetna.webp"
    - img — l:51px t:0 w:42px h:42px  |  background:rgb(173,173,173); border-radius:60px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/suzanne.webp"
    - div — l:103px t:1px w:42px h:42px  |  background:rgb(255,255,255); border-radius:60px
      - span — l:10px t:8px w:23px h:24px  |  type 18px / 600 / 24px / -0.04em / rgb(0,0,0)  |  white-space:nowrap
          text: "48"
    ...
    - span — l:172px t:2px w:127px h:40px  |  type 14px / 500 / 20px / -0.04em / rgb(255,255,255)  |  opacity:.75
        text: "Articles from the team"
  - span — l:246.151px t:213px w:163px h:40px  |  type 14px / 500 / 20px / -0.06em / rgb(255,255,255)  |  opacity:.89
      text: "From theRoars Journal"
    - br

### Insights  (top 780px, height 1620px)
background: rgb(255,255,255)  ·  overflow: hidden

- a — l:40px t:180px w:1362px h:536px  |  display:block  |  href="Roars v2 - Insight.dc.html"
  - div — l:0 t:0 w:1362px h:536px  |  background:rgb(30,30,30); border-radius:12px; overflow:hidden
    - img — w:100% h:100%  |  display:block; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2025/07/ai-fitness-home.jpg"  |  alt="How smart design boosts conversion"
    - div — l:0 h:46%  |  right:0; bottom:0; background:linear-gradient(0deg,rgba(0,0,0,.6) 0%,rgba(0,0,0,0) 100%)
    - span — l:1288px t:30px w:8px h:8px  |  background:rgba(255,255,255,.55); border-radius:50%
    - span — l:1301px t:30px w:8px h:8px  |  background:rgb(255,255,255); border-radius:50%
  - div — l:457px t:406px w:667px h:77px
    - div — l:0 t:0 w:88px h:61px
      - span — l:0 t:0 w:87px h:61px  |  type 42px / 600 / 43px / -0.05em / rgb(255,255,255)  |  white-space:nowrap
          text: "09"
      - span — l:55px t:1px w:33px h:43px  |  type 18px / 500 / 43px / -0.05em / rgb(255,255,255)  |  white-space:nowrap
          text: "Aug"
    - span — l:472px t:18px w:430px h:26px  |  type 20px / 500 / 26px / -0.04em / rgb(255,255,255)  |  white-space:nowrap
        text: "How smart design can boost conversion"
- sc-for [{{ posts }}]
  - a — l:{{ i.x }} t:{{ i.y }} w:435px h:300px  |  display:block  |  href="Roars v2 - Insight.dc.html"
    - div — l:234px t:0 w:138px h:138px  |  background-color:rgb(217,217,217); background-image:{{ i.bg }}; border-radius:50%
    - div — l:2px t:174px w:433px h:1px  |  background:rgb(153,152,149); opacity:.7
    - span — l:0 t:196px w:87px h:43px  |  type 42px / 600 / 43px / -0.05em / rgb(36,36,36)  |  white-space:nowrap
        text: "{{ i.day }}"
    - span — l:55px t:190px w:40px h:43px  |  type 18px / 500 / 43px / -0.05em / rgb(36,36,36)  |  white-space:nowrap
        text: "{{ i.month }}"
    - span — l:234px t:198px w:200px h:108px  |  type 18px / 500 / 27px / -0.03em / rgb(20,20,20)
        text: "{{ i.title }}"

### Footer  (top 2400px, height 1105px)
...
- div — display:flex; flex-direction:column; gap:34px
  ...
  - div — display:flex; align-items:center; gap:14px
    - div — display:flex; align-items:center
      - img — w:40px h:40px  |  border-radius:60px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/Chetna.webp"
      - img — w:40px h:40px  |  border-radius:60px; margin-left:-9px; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2022/07/suzanne.webp"
...
### M2 section
padding: 44px 20px 20px · background: #fff · layout: flex column gap 24px
- a — display:flex; flex-direction:column; gap:14px  |  href="Roars v2 - Insight-details.dc.html"
  - div — background:rgb(30,30,30); border-radius:12px; overflow:hidden; aspect-ratio:4/3
    - img — w:100% h:100%  |  display:block; object-fit:cover  |  src="https://www.roarsinc.com/wp-content/uploads/2025/07/ai-fitness-home.jpg"  |  alt="How smart design boosts conversion"
    - div — l:0 h:46%  |  right:0; bottom:0; background:linear-gradient(0deg,rgba(0,0,0,.6) 0%,rgba(0,0,0,0) 100%)
    - div — l:16px  |  bottom:16px; display:flex; align-items:baseline; gap:8px
      - span — type 38px / 600 / 1 / -0.05em / #fff
          text: "09"
      - span — type 17px / 500 / -0.05em / #fff
          text: "Aug"
  - span — type 22px / 500 / 30px / -0.04em / rgb(20,20,20)
      text: "How smart design can boost conversion"
...
- sc-for [{{ posts }}]
  - a — border-top:1px solid rgba(153,152,149,.7); display:flex; align-items:center; gap:16px; padding:18px 0  |  href="Roars v2 - Insight-details.dc.html"
    - div — w:84px h:84px  |  background-color:rgb(217,217,217); background-image:{{ i.bg }}; border-radius:50%; flex:none
    - div — display:flex; flex-direction:column; gap:6px; flex:1
      - div — display:flex; align-items:baseline; gap:6px
        - span — type 26px / 600 / 1 / -0.05em / rgb(36,36,36)
            text: "{{ i.day }}"
        - span — type 15px / 500 / -0.05em / rgb(36,36,36)
            text: "{{ i.month }}"
      - span — type 17px / 500 / 24px / -0.03em / rgb(20,20,20)
          text: "{{ i.title }}"
...
class Component extends DCLogic {
  ...
  renderVals() {
    ...
    const list = [
      { day: '15', month: 'May', title: 'AI App Development vs Traditional App Development', img: U + '2025/07/ai-fitness-home.jpg' },
      { day: '04', month: 'May', title: '20 Years of Roars: Built on Purpose, Driven by Impact', img: U + '2024/11/roars-office-upscale-768x768.jpg' },
      { day: '11', month: 'Dec', title: 'The Unexpected Insight — We built a meal planning app', img: U + '2025/04/beautiful-experience.jpg' },
      { day: '28', month: 'Oct', title: 'What a warehouse compliance rebuild taught us about scope', img: U + '2026/02/Snowman-Logistics-app-solution.jpg' },
      { day: '12', month: 'Aug', title: 'Behind every project: the thinking that fuels how Roars builds', img: U + '2026/04/aboutus-strategy.jpg' },
      { day: '19', month: 'Jun', title: 'Shipping an MVP in sixteen weeks without cutting the idea', img: U + '2025/07/parqly-parking-mobile-app.jpg' }
    ];
    const xs = ['40px', '501px', '962px'];
    return {
      posts: list.map((p, i) => Object.assign({}, p, {
        x: xs[i % 3],
        y: (820 + Math.floor(i / 3) * 360) + 'px',
        bg: 'url("' + p.img + '")'
      }))
    };
  }
