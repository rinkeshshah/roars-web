...
seo:
  ...
  description: "Idea, try, test, specify. Prototyping is more than trying things out: it is a structured way to check you have an efficient and fitting solution."
  primaryIntent: "prototype testing plan template"
  schemaType: "WebPage"
