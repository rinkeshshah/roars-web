...
blocks:
  - heading: "Challenges"
    lead: "While developing this health tech tool, the main challenge we faced was that creating such functionalities could help pull the data from trustable sources. Once pulled, they are compared. And, if the data is the same and available in GISAID’S database, it ignores it."
